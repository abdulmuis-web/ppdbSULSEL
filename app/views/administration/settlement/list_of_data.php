		...
		<?php
			...
			foreach($rows as $row){
				...
				echo "<td align='center'>";
	                ...
	                <a class='btn btn-default btn-xs' href='".base_url().$active_controller."/print_settlement/".urlencode($encoded_regid)."/".urlencode($encoded_fieldid)."' target='_blank'><i class='fa fa-print'></i></a>
				</td>
				</tr>";
			}
		?>
