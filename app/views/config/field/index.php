...
<div id="main" role="main">
	...
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>Home</li><li>Pengaturan</li><li>Kompetensi SMK</li>
		</ol>
	</div>
	<!-- END RIBBON -->
									...
									<div class="form-actions">
										<div class="row">
											<div class="col-md-12">										
												...
												<a id="add-button" onclick="load_form(this.id)" class="btn btn-default" data-toggle="modal" data-target="#remoteModal">
...
<script type="text/javascript">	
    ...
    function load_form(id){
        ...
        ajax_object.set_url(base_url+'config/load_field_form').set_id_input(id).set_input_ajax('ajax-req-dt').set_data_ajax(data_ajax).set_loading('#form-loader').set_content('#form-content').request_ajax();
	}

	function delete_record(id){
		ajax_object.reset_object();
        ajax_object.set_plugin_datatable(true).set_url(base_url+'config/delete_field_data').set_id_input(id).set_input_ajax('ajax-req-dt').set_data_ajax()
