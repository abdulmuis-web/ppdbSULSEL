		...
		<form action="<?=base_url();?>reg/submit_reg" id="reg-form" method="POST" class="form-horizontal">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<div class="input">
								<select name="input_kecamatan" id="input_kecamatan" onchange="get_villages(this.value,'<?=$kuota_jalur_row['jml_sekolah'];?>','<?=$stage;?>')" class="form-control" required>
									<option value=""></option>
									<?php
			...
			<div class="row">
				<div class="col-md-6">
                    ...
                    <input type="hiddens" name="input_zona" id="input_zona"/>
									...
									<tbody>";
										...
										foreach($tingkat_kejuaraan_rows as $row1){
											...
											<tr>
												...
												<input type='hidden' id='n_achievement_rows".$i."' name='n_achievement_rows".$i."'/>
												</td>
											</tr>";
										}
									echo "</tbody>
...
<script type="text/javascript">	
	...
	function get_villages(district_val,path_quota,stage){

		$.ajax({
          type:'POST',
          url:$('#baseUrl').val()+'reg/get_village_destSchool',
          data:'district='+district_val+'&path_quota='+path_quota+'&stage='+stage+'&type=1',
          beforeSend:function(){    
