<?php
	...
	if($error>0)
	{
		...
		switch($error){
			...
			case 4:$warning="Proses belum bisa dilanjutkan. Peserta masih di dalam kuota Sekolah pilihan ke - ".$prev;break;
		...
		// 		$prev = $sekolah_pilihan_row['pilihan_ke']-1;
		// 		$warning = "Proses belum bisa dilanjutkan. Silahkan melakukan verifikasi berkas pada 
		// 				   ".($this->session->userdata('tipe_sekolah')=='1'?'Sekolah':'Kompetensi')." Pilihan ke ".$prev." terlebih dahulu!";
		// 	}
		// }
			...
			<div id="bootstrap-wizard-1" class="col-sm-12">
				<div class="form-bootstrapWizard">
					<ul class="bootstrapWizard form-wizard">
						...
						<?php
						$nextStep = 3;
						if($sekolah_pilihan_row['tipe_sekolah']!='2' and $pendaftaran_row['tipe_jalur']=='1')
						{
							$nextStep++;
							echo "
								...
								<tbody>
									...
									if($this->session->userdata('tipe_sekolah')=='1')
									{
										...
										<tr>
											...
											<td>".$sekolah_pilihan_row['nama_sekolah']."/".$sekolah_pilihan_row['pilihan_ke']." (".NumToWords($sekolah_pilihan_row['pilihan_ke']).")</td>
										</tr>";
									}else{
										echo "
										<tr><td>Sekolah Tujuan</td><td>".$sekolah_pilihan_row['nama_sekolah']."</td></tr>
										<tr><td>Kompetensi Tujuan</td>
										<td>".$sekolah_pilihan_row['nama_kompetensi']."/".$sekolah_pilihan_row['pilihan_ke']." (".NumToWords($sekolah_pilihan_row['pilihan_ke']).")</td>
										</tr>";
									}
								echo "</tbody>
								</table>
