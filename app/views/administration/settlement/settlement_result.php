<?php	
	...
	<div class='col-md-6 col-md-offset-3'>
		...
		<tbody>
			...
			<tr>
			<td></td>
			<td><a class='btn btn-default' href='".base_url().$active_controller."/print_settlement/".urlencode($encoded_regid)."/".urlencode($encoded_fieldid)."' target='_blank'><i class='fa fa-print'></i> Cetak</a></td>
			</tr>
		</tbody>
		</table>
	</div>";
