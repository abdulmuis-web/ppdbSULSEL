			...
			<div class="fluid">				
				<div class="grid12">					
					...
					<table class='report' cellpadding='0' cellspacing='0'>
						<tbody>
							...
							if($sekolah_pilihan_row['tipe_sekolah_id']=='1'){
								echo "<tr><td>Sekolah Tujuan</td><td>".$sekolah_pilihan_row['nama_sekolah']."</td></tr>";
							}else{
								echo "
								<tr><td>Sekolah Tujuan</td><td>".$sekolah_pilihan_row['nama_sekolah']."</td></tr>
								<tr><td>Kompetensi Tujuan</td><td>".$sekolah_pilihan_row['nama_kompetensi']."</td></tr>";
							}

							echo "<tr><td>Tgl. Pendaftaran Ulang</td><td>".indo_date_format($log_status_row['tgl_verifikasi'],'longDate')."</td></tr>
					...
					<table width='100%'>
						<tr>
							<td width='50%'></td>
							<td align='right'>". ucwords(strtolower($this->session->userdata('dt2'))).", ".indo_date_format(date('Y-m-d'),'longDate')."</td>
						</tr>
